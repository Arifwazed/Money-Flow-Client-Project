    ...
    return (
        <div>
            <footer className="footer sm:footer-horizontal p-10 bg-[#2D5DA9] text-white">
                <aside>
                    <a className="font-bold text-xl flex items-center text-green-500"><img width="35" height="35" src="https://img.icons8.com/3d-fluency/94/dollar-bitcoin-exchange.png" alt="dollar-bitcoin-exchange"/>Money<span className='text-amber-300'>Flow</span></a>
                    <p className='max-w-100'>
                    Easily track spending, set goals, and visualize your progress through beautiful charts. 
                    
                    Your journey to better financial balance starts here.
                    </p>
                </aside>
                <div className='grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-40'>
